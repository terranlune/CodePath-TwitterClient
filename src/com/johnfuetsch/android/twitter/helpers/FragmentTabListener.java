...
public class FragmentTabListener<T extends Fragment> implements TabListener {
	...
	public void onTabSelected(Tab tab, android.app.FragmentTransaction ft) {
		...
		if (mFragment == null) {
			Log.e("FragmentTabListener", "Creating new fragment " + mClass.getName());
			// If not, instantiate and add it to the activity
			mFragment = Fragment.instantiate(mActivity, mClass.getName());
			sft.add(mfragmentContainerId, mFragment, mTag);
		} else {
			Log.e("FragmentTabListener", "Reattaching fragment " + mClass.getName());
	...
	public void onTabUnselected(Tab tab, android.app.FragmentTransaction ft) {
		FragmentTransaction sft = mActivity.getFragmentManager().beginTransaction();
		if (mFragment != null) {
			Log.e("FragmentTabListener", "Detaching fragment " + mClass.getName());
